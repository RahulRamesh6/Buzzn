...
class ProfilePicForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('profile_picture','profile_bio','homepage_link','facebook_link','instagram_link','linkedin_link',)

class BuzzForm(forms.ModelForm):
    body = forms.CharField(required=True,widget=forms.widgets.Textarea(attrs={"placeholder":"Enter your Buzz!","class":"form-control",}),label="",)
